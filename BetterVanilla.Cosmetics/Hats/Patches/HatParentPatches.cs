...
internal static class HatParentPatches
{
    ...
    private static bool SetHatPrefix(HatParent __instance, int color)
    {
        ...
        if (!CosmeticsManager.Instance.Hats.TryGetViewData(__instance.Hat.ProductId, out _)) return true;
    ...
    private static bool UpdateMaterialPrefix(HatParent __instance)
    {
        ...
        if (!CosmeticsManager.Instance.Hats.TryGetViewData(__instance.Hat.ProductId, out var asset))
        {
            return true;
        }
        CosmeticsManager.Instance.Hats.UpdateMaterialFromViewAsset(__instance, asset);
        return false;
    }
    ...
    private static bool SetFloorAnimPrefix(HatParent __instance)
    {
        ...
        if (!CosmeticsManager.Instance.Hats.TryGetViewData(__instance.Hat.ProductId, out var asset)) return true;
    ...
    private static bool PopulateFromHatViewDataPrefix(HatParent __instance)
    {
        ...
        CosmeticsManager.Instance.Hats.PopulateParentFromAsset(__instance, asset);
        return false;
    }
}