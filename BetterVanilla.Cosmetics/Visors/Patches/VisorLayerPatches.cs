...
internal static class VisorLayerPatches
{
    ...
    private static bool UpdateMaterialPrefix(VisorLayer __instance)
    {
        ...
        if (!CosmeticsManager.Instance.Visors.TryGetViewData(__instance.visorData.ProductId, out var asset))
        {
            return true;
        }
        CosmeticsManager.Instance.Visors.UpdateMaterialFromViewAsset(__instance, asset);
        return false;
    }
    ...
    private static bool SetFloorAnimPrefix(VisorLayer __instance)
    {
        ...
        if (!CosmeticsManager.Instance.Visors.TryGetViewData(__instance.visorData.ProductId, out var asset)) return true;
    ...
    private static bool PopulateFromViewDataPrefix(VisorLayer __instance)
    {
        ...
        CosmeticsManager.Instance.Visors.PopulateParentFromAsset(__instance, asset);
        return false;
    }
