...
internal static class CosmeticsLayerPatches
{
    ...
    {
        if (CosmeticsManager.Instance.Visors.TryGetViewData(visor.visorData.ProductId, out var viewData))
        {
            CosmeticsManager.Instance.Visors.PopulateParentFromAsset(visor, viewData);
        }
        else
        {
