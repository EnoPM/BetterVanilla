...
{
    extension(GameOptionsMenu menu)
    {
        public bool CustomValueChanged(OptionBehaviour optionBehaviour)
        {
        ...
        public void CreateBetterSettings()
        {
            var y = 0.713f;
            foreach (var allCategory in GameManager.Instance.GetAllCategories())
            {
                ...
                {
                    var customHostOption =
                        isCustomCategory ? HostOptions.Default.FindOptionByGameSetting(gameSetting) : null;
                    UpdateSettingConstraints(gameSetting);
                    switch (gameSetting.Type)
                    {
                        case OptionTypes.Checkbox:
                            var toggleOptionBehaviour = Object.Instantiate(menu.checkboxOrigin, Vector3.zero,
                        ...
                        case OptionTypes.String:
                            var stringOptionBehaviour = Object.Instantiate(menu.stringOptionOrigin, Vector3.zero,
                                Quaternion.identity, menu.settingsContainer);
                        ...
                        case OptionTypes.Int:
                            var numberOptionBehaviour = Object.Instantiate(menu.numberOptionOrigin, Vector3.zero,
                                Quaternion.identity, menu.settingsContainer);
                        ...
                        case OptionTypes.Player:
                            var playerOptionBehaviour = Object.Instantiate(menu.playerOptionOrigin, Vector3.zero,
                                Quaternion.identity, menu.settingsContainer);
