...
public abstract class BaseControl : MonoBehaviour, IViewControl
{
    ...
    {
        var refSize = GetReferenceSize();
        MinWidth = refSize.x * (percent / 100f);
    }
    ...
    {
        var refSize = GetReferenceSize();
        MinHeight = refSize.y * (percent / 100f);
    }
    ...
    {
        var refSize = GetReferenceSize();
        MaxWidth = refSize.x * (percent / 100f);
    }
    ...
    {
        var refSize = GetReferenceSize();
        MaxHeight = refSize.y * (percent / 100f);
    }
